...
local lines = {
  ...
  '',
  'CUT AND DELETE',
  '  d           Delete the selection without replacing copied text',
  '  dd / diw    Delete the current line / word without copying',
  '  dG / D      Delete to file end / line end without copying',
  '  yG          Copy from the current line to the end of the file',
  '  x           Delete a character and keep it for paste',
